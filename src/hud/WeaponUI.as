package hud 
{
	...
	public class WeaponUI extends FlxSprite
	{
		...
		{
			if (_weaponID == 0) play("normal");
			else if (_weaponID == 1) play("bounce");
			else if (_weaponID == 2) play("crossbow");
			else if (_weaponID == 3) play("spread");
			else if (_weaponID == 4) play("sniper");
		}
