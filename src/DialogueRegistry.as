package  
{
	...
	public class DialogueRegistry 
	{
		...
		public static var angryResponse:String = GUY_TITLE + "Why would I try to pick a fight with such a handsome creature such as yourself?"
			+ " You just looked like you needed a friendly kick in the arse!";
			
		// girl
		public static var girl_intro1:String = GIRL_TITLE + "Hello this is the best ever I can't even believe it so awsome and good and amazing!";
		public static var girl_outro1:String = GIRL_TITLE + "Goodbye..";
		public static var sad:String = GIRL_TITLE + "Thou hath taken away from me my dearest companion, perhaps my last."
			+ " Please, just let me be...";
		
		// beast
		public static var beast_intro1:String = BEAST_TITLE + "Aye, it's Patches! You're pretty tough for such a small man.";
		public static var beast_outro1:String = BEAST_TITLE + "You're a jerk with a heart of gold.. Don't let em take it from ye!";
